<x-admin-layout>
    ...
    <div class="d-flex flex-row">
            ...
            <div class="card card-custom card-stretch">
                ...
                <div class="card-body pt-4">
                    ...
                    <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                        @can('index-menu-activation-products')
                        <div class="navi-item mb-2">
                            <a href="{{ route('dashboard.menu-activation.products') }}" class="navi-link py-4">
                                <span class="navi-text font-size-lg">{{ __('Products') }}</span>
                            </a>
                        </div>
                        @endcan
                        @can('index-menu-activation-categories')
                        <div class="navi-item mb-2">
                            <a href="{{ route('dashboard.menu-activation.categories') }}" class="navi-link py-4 active">
                                <span class="navi-text font-size-lg">{{ __('Categories') }}</span>
                            </a>
                        </div>
                        @endcan
                        @can('index-menu-activation-sizes')
                        <div class="navi-item mb-2">
                        ...
                        @endcan
                        @can('index-menu-activation-tags')
                        <div class="navi-item mb-2">
                        ...
                        @endcan
                        @can('index-menu-activation-modifiers')
                        <div class="navi-item mb-2">
        ...
        <div class="flex-row-fluid ml-lg-8">
            <livewire:dashboard.menu-activation.categories>
        </div>
    </div>
</x-admin-layout>
