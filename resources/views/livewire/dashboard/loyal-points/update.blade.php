                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input wire:model.lazy="loyalPoint.name_en" field='name_en' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input wire:model.lazy="loyalPoint.name_ar" field='name_ar' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input type="number" wire:model.lazy="loyalPoint.points" field='points' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group">
                                            <input type="number" class="form-control @error('discount') is-invalid @enderror" wire:model.lazy="loyalPoint.discount">
