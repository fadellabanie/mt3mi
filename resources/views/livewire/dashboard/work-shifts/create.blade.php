                        ...
                        <div class="row">
                            ...
                            <div class="my-2 col-xl-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="time" class="form-control @error('from_time') is-invalid @enderror" wire:model.defer="from_time">
                                        <x-error field="from_time" />
                                    </div>
                                    <x-label>{{ __('To Time') }}</x-label>
                                    <div class="col-lg-3">
                                        <input type="time" class="form-control @error('to_time') is-invalid @enderror" wire:model.defer="to_time">
