    ...
    <div class="card card-custom">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">{{ __('Combos') }}</span>
                <span class="text-muted mt-3 font-weight-bold font-size-sm">{{ __('Show All') }}</span>
            </h3>
            <div class="d-flex align-items-center">
                @canany(['Export Combo','Import Combo'])
                <x-export field='{{$products->isEmpty()}}' export='Export Combo' import='Import Combo'></x-export>
                @endcan
                <x-import-modal file='combos.xlsx'></x-import-modal>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pr-0 text-left">
                                <a href="{{ route('dashboard.products.components.index', $product) }}"
