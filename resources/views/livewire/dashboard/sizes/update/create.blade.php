<div>
    <div wire:ignore.self class="modal fade" id="createSizeModal" tabindex="-1" role="dialog" aria-labelledby="createSizeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form class="form" id="kt_form2" x-data="{ cost_type: 'variable' }">
                    <div class="modal-header">
                        <h5 class="modal-title" id="createSizeModalLabel">{{ __('New Size') }}</h5>
