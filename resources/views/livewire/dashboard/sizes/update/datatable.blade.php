<div>
                        ...
                        @forelse($sizes as $size)
                            <tr>
                                ...
                                <td class="pr-0 text-left">
                                    <x-edit-record-button href="javascript:void(0)" wire:click="selectSize({{ $size->id }}, 'update')" />
                                    <x-delete-record-button href="javascript:void(0)" wire:click="selectSize({{ $size->id }}, 'delete')"  />
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    @include('livewire.dashboard.sizes.update.create')
    @include('livewire.dashboard.sizes.update.update')
</div>
