<div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                    ...
                    <tbody>
                        @forelse($sizes->sortBy('uid') as $key => $size)
                            <tr>
                                <td class="pl-0">
                                ...
                                <td class="pr-0 text-left">
                                    <x-edit-record-button href="javascript:void(0)" wire:click="selectSize({{ $size['uid'] }}, 'update')" />
                                    <x-delete-record-button href="javascript:void(0)" wire:click="selectSize({{ $size['uid'] }}, 'delete')"  />
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    @include('livewire.dashboard.sizes.create.create')
    @include('livewire.dashboard.sizes.create.update')
</div>
