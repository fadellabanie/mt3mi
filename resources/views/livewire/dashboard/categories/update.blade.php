                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input wire:model.defer="category.name_en" field='name_en' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input wire:model.defer="category.name_ar" field='name_ar' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input wire:model.defer="category.sku" field='sku' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                                    ...
                                    <div class="col-9" wire:ignore>
                                        <select class="form-control select2 @error('categoryTimedEvents') is-invalid @enderror" id="kt_select2_4" name="categoryTimedEvents" multiple="multiple">
                                            @foreach($timedEvents as $timedEvent)
                                                <option value="{{ $timedEvent->id }}" @if(in_array($timedEvent->id, $categoryTimedEvents)) selected @endif>{{ $timedEvent->name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    >
                                        ...
                                        @else
                                            <div class="symbol symbol-150 mt-5">
                                                <img alt="" src="{{ asset('storage/' . $category->icon) }}"/>
                                            </div>
                                        @endif
                                    </div>
                                </div>
