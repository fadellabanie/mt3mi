<div>
                        ...
                        @forelse($options as $option)
                            <tr>
                                ...
                                <td class="pr-0 text-left">
                                    <x-edit-record-button href="javascript:void(0)" wire:click="selectOption({{ $option->id }}, 'update')" />
                                    <x-delete-record-button href="javascript:void(0)" wire:click="selectOption({{ $option->id }}, 'delete')"  />
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    @include('livewire.dashboard.options.update.create')
    @include('livewire.dashboard.options.update.update')
</div>
