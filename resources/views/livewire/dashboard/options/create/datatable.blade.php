<div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                    ...
                    <tbody>
                        @forelse($options->sortBy('uid') as $key => $option)
                            <tr>
                                <td class="pl-0">
                                ...
                                <td class="pr-0 text-left">
                                    <x-edit-record-button href="javascript:void(0)" wire:click="selectOption({{ $option['uid'] }}, 'update')" />
                                    <x-delete-record-button href="javascript:void(0)" wire:click="selectOption({{ $option['uid'] }}, 'delete')"  />
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    @include('livewire.dashboard.options.create.create')
    @include('livewire.dashboard.options.create.update')
</div>
