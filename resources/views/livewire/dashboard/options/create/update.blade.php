            ...
            <div class="modal-content">
                <form class="form" id="kt_form2">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editOptionModalLabel">{{ (app()->getLocale() == 'ar') ? $name_ar : $name_en }}</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input type="number" wire:model.lazy="cost" field='cost' min="0" />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input type="number" wire:model.lazy="calories" field='calories' min="0" />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input type="number" wire:model.lazy="price" field='price' min="0" />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
