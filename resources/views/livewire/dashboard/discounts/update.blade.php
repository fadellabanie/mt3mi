                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input wire:model.defer="discount.name_en" field='name_en' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input wire:model.defer="discount.name_ar" field='name_ar' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <select class="form-control @error('type') is-invalid @enderror" wire:model.lazy="discount.type">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <span class="switch switch-sm switch-icon">
                                        <label>
                                            <input type="checkbox" wire:model.defer="discount.is_taxable" />
                                            <span></span>
                                        </label>
                                    </span>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group">
                                            <input type="number" class="form-control @error('value') is-invalid @enderror" wire:model.defer="discount.value">
                                            <div class="input-group-append">
                                                <span class="input-group-text">{{ ($this->discount->type == 'Value') ? 'SAR' : '%' }}</span>
                                            </div>
                                            <x-error field="value" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="checkbox-inline @error('applies_to') is-invalid @enderror">
                                            @foreach($applyTypes as $applyType)
                                                <label class="checkbox">
                                                    <input type="checkbox" value="{{ $applyType['key'] }}" wire:model.defer="discount.applies_to" />
                                                    <span></span>
                                                    {{ __($applyType['name']) }}
                                                </label>
                                            @endforeach
                                    ...
                                    <div class="col-9">
                                        <div class="checkbox-inline @error('activate_for') is-invalid @enderror">
                                            @foreach($activationTypes as $activationType)
                                                <label class="checkbox">
                                                    <input type="checkbox" value="{{ $activationType['key'] }}" wire:model.defer="discount.activate_for" />
                                                    <span></span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-date-picker field="discount.start_date" wire:model.defer="discount.start_date" minDate="new Date()" />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9" wire:ignore>
                                        <select class="form-control select2 @error('discountCategories') is-invalid @enderror" id="discountCategories"
                                            ...
                                            <option value="{{ $category->id }}" @if(in_array($category->id, $discountCategories)) selected
                                    ...
                                    <div class="col-9" wire:ignore>
                                        <select class="form-control select2 @error('discountProducts') is-invalid @enderror"
                                            ...
                                            @foreach($products as $product)
                                                <option value="{{ $product->id }}" @if(in_array($product->id, $discountProducts)) selected @endif>{{ $product->name }}</option>
                                            @endforeach
                                        </select>
