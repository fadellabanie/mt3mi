            ...
            <div class="flex-wrap container-fluid d-flex align-items-center justify-content-between flex-sm-nowrap">
                ...
                <div class="flex-wrap mr-1 d-flex align-items-center">
                    ...
                    <div class="flex-wrap mr-5 d-flex align-items-baseline">
                        <!--begin::Page Title-->
                        <h5 class="my-1 mr-5 text-dark font-weight-bold">{{ __('Create new tax') }}</h5>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="my-2 col-xl-7">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input type="number" wire:model.defer="percentage" field='percentage' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="my-2 col-xl-7">
                        ...
                        <div class="form-group row">
                            ...
                            <x-date-picker field="start_date" wire:model="start_date" minDate="new Date()" />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
