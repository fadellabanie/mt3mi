                        ...
                        <div class="row">
                            ...
                            <div class="my-2 col-xl-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input wire:model.defer="delayPolicy.name_en" field='name_en' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="my-2 col-xl-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <x-input wire:model.defer="delayPolicy.name_ar" field='name_ar' />
                                </div>
                                <!--end::Group-->
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group">
                                            <input type="number" class="form-control @error('calculate_after') is-invalid @enderror" wire:model.defer="delayPolicy.calculate_after" min="1">
                        ...
                        <div class="row">
                            ...
                            <div class="my-2 col-xl-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group">
                                            <input type="number" class="form-control @error('discount_from_salary') is-invalid @enderror" wire:model.defer="delayPolicy.discount_from_salary" min="0" step="any">
                                            <div class="input-group-append">
