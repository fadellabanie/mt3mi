    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            <form class="form" id="kt_form1">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input wire:model.lazy="inventoryItem.name_en" field='name_en' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input wire:model.lazy="inventoryItem.name_ar" field='name_ar' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control @error('type') is-invalid @enderror" wire:model.lazy="inventoryItem.type">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input wire:model.lazy="inventoryItem.sku" field='sku' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input wire:model.lazy="inventoryItem.barcode" field='barcode' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9" wire:ignore>
                                <select class="form-control select2 @error('itemTags') is-invalid @enderror" id="kt_select2_3" name="itemTags" multiple="multiple">
                                    @foreach($tags as $tag)
                                        <option value="{{ $tag->id }}" @if(in_array($tag->id, $itemTags)) selected @endif>{{ $tag->name }}</option>
                                    @endforeach
                                </select>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input wire:model.lazy="inventoryItem.purchase_unit" field='purchase_unit' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input wire:model.lazy="inventoryItem.storage_unit" field='storage_unit' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input wire:model.lazy="inventoryItem.ingredient_unit" field='ingredient_unit' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input type="number" wire:model.lazy="inventoryItem.purchase_to_storage_factor" field='purchase_to_storage_factor' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input type="number" wire:model.lazy="inventoryItem.storage_to_ingredient_factor" field='storage_to_ingredient_factor' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select class="form-control @error('cost_type') is-invalid @enderror" wire:model.lazy="inventoryItem.cost_type">
                                    <option value="fixed">{{ __('Fixed cost per') }} {{ $this->inventoryItem->storage_unit }}</option>
                ...
                <!--end::Row-->
                @if($this->inventoryItem->cost_type == 'fixed')
                <!--begin::Row-->
                <div class="row">
                    <div class="col-xl-2"></div>
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input type="number" wire:model.lazy="inventoryItem.cost" field='cost' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 my-2">
                        ...
                        <div class="form-group row">
                            ...
                            <x-input type="number" wire:model.lazy="inventoryItem.minimum_level_alert" field='minimum_level_alert' />
                        </div>
                        <!--end::Group-->
                    </div>
                </div>
