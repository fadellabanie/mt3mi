                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="date" class="form-control @error('from_date') is-invalid @enderror" wire:model.lazy="from_date">
                                        <x-error field="from_date" />
                                    </div>
                                    <x-label>{{ __('To Date') }}</x-label>
                                    <div class="col-lg-3">
                                        <input type="date" class="form-control @error('to_date') is-invalid @enderror" wire:model.lazy="to_date">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 my-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        <input type="time" class="form-control @error('from_hour') is-invalid @enderror" wire:model.lazy="from_hour">
                                        <x-error field="from_hour" />
                                    </div>
                                    <x-label>{{ __('To Hour') }}</x-label>
                                    <div class="col-lg-3">
                                        <input type="time" class="form-control @error('to_hour') is-invalid @enderror" wire:model.lazy="to_hour">
